...
from networking_nec.plugins.necnwa.necnwa_core_plugin import (  # noqa
    NECNWACorePlugin,
    NECNWARpcCallbacks
)
...
class TestNECNWACorePlugin(base.BaseTestCase):
    ...
    @patch('networking_nec.plugins.necnwa.necnwa_core_plugin.NECNWACorePlugin._setup_rpc')  # noqa
    ...
    @patch('neutron.db.db_base_plugin_common.DbBasePluginCommon._make_network_dict')  # noqa
    @patch('networking_nec.plugins.necnwa.necnwa_core_plugin.NECNWACorePlugin._extend_network_dict_provider')  # noqa
...
class TestNECNWARpcCallbacks(base.BaseTestCase):

    @patch('networking_nec.plugins.necnwa.necnwa_core_plugin.NECNWACorePlugin._setup_rpc')  # noqa
    @patch('neutron.plugins.ml2.managers.TypeManager.initialize')
    def setUp(self, f1, f2):
        super(TestNECNWARpcCallbacks, self).setUp()
        notifier = MagicMock()
        type_manager = MagicMock()

        self.rpc = NECNWARpcCallbacks(notifier, type_manager)
    ...
    @patch('networking_nec.plugins.necnwa.necnwa_core_plugin.NECNWACorePlugin.get_bound_port_context')  # noqa
    @patch('networking_nec.plugins.necnwa.necnwa_core_plugin.NECNWACorePlugin._device_to_port_id')  # noqa
    ...
    @patch('networking_nec.plugins.necnwa.necnwa_core_plugin.NECNWACorePlugin.update_port_status')  # noqa
    @patch('networking_nec.plugins.necnwa.db.api.ensure_port_binding')
    @patch('neutron.plugins.ml2.db.get_network_segments')
    @patch('neutron.db.api.get_session')
    @patch('networking_nec.plugins.necnwa.necnwa_core_plugin.NECNWACorePlugin.get_bound_port_context')  # noqa
