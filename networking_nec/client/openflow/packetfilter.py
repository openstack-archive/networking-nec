...
class ListPacketFilter(extension.ClientExtensionList, PacketFilter):
    """List packet filters that belong to a given tenant."""

    shell_command = 'nec-packet-filter-list'
...
class ShowPacketFilter(extension.ClientExtensionShow, PacketFilter):
    """Show information of a given packet filter."""

    shell_command = 'nec-packet-filter-show'
...
class CreatePacketFilter(PacketFilterOptionMixin, PacketFilter,
                         extension.ClientExtensionCreate):
    """Create a packet filter for a given tenant."""

    shell_command = 'nec-packet-filter-create'
...
class UpdatePacketFilter(PacketFilterOptionMixin, PacketFilter,
                         extension.ClientExtensionUpdate):
    """Update packet filter's information."""

    shell_command = 'nec-packet-filter-update'
...
class DeletePacketFilter(extension.ClientExtensionDelete, PacketFilter):
    """Delete a given packet filter."""

    shell_command = 'nec-packet-filter-delete'
