...
class TenantBindingServerRpcCallback(object):
    ...
    def update_tenant_rpc_servers(self, rpc_context, **kwargs):
        ...
        tenant_ids = [server['tenant_id'] for server in kwargs.get('servers')]
        ret = []
        for tenant_id in list(set(q_tids) - set(tenant_ids)):
        ...
        for tenant_id in list(set(tenant_ids) - set(q_tids)):
