...
class PacketFilterBase(extension.NeutronClientExtension):
...
class ListPacketFilter(PacketFilterBase, extension.ClientExtensionList):
...
class ShowPacketFilter(PacketFilterBase, extension.ClientExtensionShow):
...
class DeletePacketFilter(PacketFilterBase, extension.ClientExtensionDelete):
