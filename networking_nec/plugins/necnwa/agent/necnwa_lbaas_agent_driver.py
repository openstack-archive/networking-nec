...
from networking_nec.plugins.necnwa.agent.agent_base_driver \
    import POLICY_CREATE
from networking_nec.plugins.necnwa.agent.agent_base_driver \
    import POLICY_DELETE
from networking_nec.plugins.necnwa.agent.agent_base_driver \
    import POLICY_TYPE_HEALTHMONITOR
from networking_nec.plugins.necnwa.agent.agent_base_driver \
    import POLICY_TYPE_MEMBER
from networking_nec.plugins.necnwa.agent.agent_base_driver \
    import POLICY_TYPE_POOL
from networking_nec.plugins.necnwa.agent.agent_base_driver \
    import POLICY_TYPE_VIP
from networking_nec.plugins.necnwa.agent.agent_base_driver \
...
class NECNWALBaaSAgentDriver(NECNWAAgentBaseDriver):
    ...
    def _create_pool_health_monitor(self, context, health_mon, pool_id):
        ...
        for hm in health_mon['pools']:
            ...
            result, nwa_data = self.nwa_setting_lb_policy(
                context, tid, nwa_tid, POLICY_TYPE_HEALTHMONITOR,
                POLICY_CREATE,
