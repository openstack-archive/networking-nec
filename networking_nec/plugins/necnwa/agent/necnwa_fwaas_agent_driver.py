...
from networking_nec.plugins.necnwa.agent.agent_base_driver \
    import NECNWAAgentBaseDriver
from networking_nec.plugins.necnwa.agent.agent_base_driver import POLICY_CREATE
from networking_nec.plugins.necnwa.agent.agent_base_driver import POLICY_DELETE
# from networking_nec.plugins.necnwa.agent.agent_base_driver import POLICY_DENY
from networking_nec.plugins.necnwa.agent.agent_base_driver import POLICY_PERMIT
from networking_nec.plugins.necnwa.agent.agent_base_driver import POLICY_RULE
from networking_nec.plugins.necnwa.agent.agent_base_driver import POLICY_UPDATE
    ...
    def update_firewall(self, context, **kwargs):
        ...
        for router_id in add_router_ids:
            ...
            if router_key in nwa_data.keys():
                ...
                LOG.debug("set policy in router.")
                # self.nwa_setting_fw_policy(context, tid, nwa_tid, tfw,
                # firewall, POLICY_RULE, POLICY_CREATE)
                self.nwa_setting_fw_policy(context, tid, nwa_tid, tfw,
                                           firewall, POLICY_RULE,
                                           POLICY_UPDATE)
        ...
        for router_id in del_router_ids:
            ...
            if router_key in nwa_data.keys():
                ...
                # self.nwa_setting_fw_policy(context, tid, nwa_tid, tfw,
                # firewall, POLICY_RULE, POLICY_DELETE)
                self.nwa_setting_fw_policy(context, tid, nwa_tid, tfw,
